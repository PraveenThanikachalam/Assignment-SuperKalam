...
export default function Home() {
  return (
    <div className="w-full md:relative absolute md:h-full h-[85%] overflow-y-scroll text-white px-2 md:px-16 py-5 md:py-10 flex flex-col gap-y-5 md:gap-y-10 bg-zinc-900">
      <StickySearchBar />
